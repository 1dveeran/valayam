...
macro_rules! impl_template_section {
    ...
    ($ty:ty, $name:expr, $desc:expr) => {
        impl TemplateSection for $ty {
            fn section_name(&self) -> &'static str { $name }
            fn section_description(&self) -> &str { $desc }
        }
    };
}
...
impl_template_section!(super::azure_gcp_escalate::AzureGcpEscalateTemplate, "azure-gcp-escalate");
...
impl_template_section!(super::client_secret_audit::ClientSecretAuditTemplate, "client-secret-audit");
impl_template_section!(super::cloud_sec::CloudTemplate, "cloud");
impl_template_section!(super::container_audit::ContainerAuditTemplate, "container-audit");
...
impl_template_section!(super::dependency_audit::DependencyAuditTemplate, "dependency-audit");
impl_template_section!(super::dns_audit::DnsRequestTemplate, "dns");
impl_template_section!(super::dom_redirect_audit::DomRedirectAuditTemplate, "dom-redirect-audit");
...
impl_template_section!(super::header_scorecard::HeaderScorecardTemplate, "header-scorecard");
...
impl_template_section!(super::implant_deploy::ImplantDeployTemplate, "implant-deploy");
...
impl_template_section!(super::pii_leak_audit::PiiLeakAuditTemplate, "pii-leak-audit");
impl_template_section!(super::port_scan::PortScanTemplate, "port-scan");
impl_template_section!(super::remediation_gen::RemediationGenTemplate, "remediation-gen");
impl_template_section!(super::reputation_audit::ReputationAuditTemplate, "reputation-audit");
...
impl_template_section!(super::serverless_audit::ServerlessAuditTemplate, "serverless-audit");
impl_template_section!(super::subdomain_takeover::SubdomainTakeoverTemplate, "subdomain-takeover");
impl_template_section!(super::tls_audit::TlsAuditTemplate, "tls");
impl_template_section!(super::ui_proxy::UiProxyTemplate, "ui-proxy");
impl_template_section!(super::waf_bypass_verify::WafBypassVerifyTemplate, "waf-bypass-verify");

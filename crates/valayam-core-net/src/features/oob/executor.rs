...
impl OobExecutor {
    ...
    pub async fn wait_for_interaction_with_config(
        ...
        while tokio::time::Instant::now() < deadline {
            // Check at least once even after deadline
            {
...
mod tests {
    ...
    async fn test_wait_for_interaction_timeout() {
        // No server running — should just time out quickly
        ...
        // Without a running server, wait_for_interaction should return false
        // We test the timeout path by using the config directly
